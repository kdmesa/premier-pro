        ...
        <div className="container mx-auto grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] items-center">
          <div className="space-y-6">
            ...
            <p className="text-base sm:text-lg text-slate-200 max-w-xl">
              Orbit Booking gives cleaners and local service businesses a modern booking experience with online scheduling, automated reminders, and payments built in.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose the perfect plan for your service business. No hidden fees, cancel anytime.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="border-2 border-transparent rounded-xl p-6 hover:shadow-lg transition-shadow flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-6">Perfect for small businesses getting started</p>
              <div className="mb-6">
            ...
            <div className="border-2 border-primary rounded-xl p-6 shadow-lg relative -mx-[1px] flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-6">For growing teams with advanced needs</p>
              <div className="mb-6">
            ...
            <div className="border-2 border-transparent rounded-xl p-6 hover:shadow-lg transition-shadow flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm mb-6">For established businesses with high volume</p>
              <div className="mb-6">
