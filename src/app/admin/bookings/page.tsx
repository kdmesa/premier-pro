            ...
            <div className="grid grid-cols-7 gap-2">
              ...
              {Array.from({ length: daysInMonth }).map((_, index) => {
                ...
                return (
                  <div
                    key={day}
                    className={`h-24 rounded-lg p-2 transition-all cursor-pointer ${
                      isToday 
                        ? 'bg-blue-100 dark:bg-cyan-950/20 border-2 border-blue-400' 
                        : 'bg-white dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50'
                    }`}
                  >
                    <div className="flex flex-col h-full">
                      <div className={`text-sm font-medium mb-1 ${
                        isToday ? 'text-blue-600 dark:text-cyan-400' : 'text-gray-700 dark:text-gray-300'
                      }`}>
                        {day}
                      </div>
                      {hasBookings && (
