...
export default function PricingParameterNewPage() {
  ...
  }, [allDataKey, variablesKey, extrasKey, servicesKey]);
          ...
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="details" className="mt-4 space-y-5">
              <div className="space-y-2">
                ...
                {variables.length === 0 ? (
                  <p className="text-sm text-muted-foreground">No variables available. Please add variables first.</p>
                ) : (
                  <select
                  ...
                  >
                    ...
                    {variables.map((variable) => (
                      <option key={variable.id} value={variable.category}>
                        {variable.name}
                      </option>
                    ))}
                  </select>
