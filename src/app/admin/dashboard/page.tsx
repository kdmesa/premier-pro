              ...
              <div className="grid grid-cols-7 gap-1">
                ...
                {Array.from({ length: daysInMonth }).map((_, index) => {
                  ...
                  const dayBaseClass = cn(
                    ...
                    today
                      ? "bg-cyan-500/20 border-cyan-400 border-2 neon-cyan"
                      : hasBookings
                        ...
                        : "border-cyan-500/10 hover:bg-white/5"
                  );
                  ...
                  return (
                    ...
                    >
                      <div className={`text-xs font-semibold mb-1 ${today ? 'text-cyan-300' : 'text-gray-400'}`}>
                        {day}
                      </div>
              ...
              <div className="mt-4">
                ...
                <div className="space-y-2">
                  {(bookingsByDate[selectedDate] || []).map((booking) => (
                    ...
                    >
                      <div>
                        <p className="font-medium text-cyan-300">{booking.customerName}</p>
                        <p className="text-xs text-gray-400">{booking.service} • {booking.time}</p>
                      </div>
                      <span className="text-xs text-cyan-400 uppercase">{booking.status}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <p className="font-semibold text-sm text-cyan-300">{booking.customerName}</p>
                ...
                <div className="flex items-center justify-between text-xs text-gray-400">
                  ...
                  <span className="font-semibold text-cyan-300">{booking.amount}</span>
                </div>
              </div>
            ))}
          </div>
