            ...
            {sidebarOpen ? (
              <>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className={`text-sm font-semibold uppercase tracking-wide ${theme === 'dark' ? 'text-cyan-400' : 'text-black'}`}>Orbit Booking</h2>
                    <p className={`text-xs ${theme === 'dark' ? 'text-cyan-300/60' : 'text-black/60'}`}>Admin Panel</p>
                  </div>
                </div>
                <Button
                  variant="ghost"
                  ...
                  {sidebarOpen && (
                    <>
                      <div className="flex-1 text-left">
                        <p className="text-sm font-medium text-cyan-300">{adminEmail.split('@')[0]}</p>
                        <p className="text-xs text-cyan-300/60 truncate">{adminEmail}</p>
                      </div>
      ...
      >
        ...
        <header className="sticky top-0 z-30 shadow-lg glass-header">
          <div className="flex items-center justify-between px-6 py-4">
            <div>
              <h1 className={`text-2xl font-bold ${theme === 'dark' ? 'text-cyan-300' : 'text-black'}`}>
                {(() => {
              ...
              {pathname === "/admin/dashboard" && (
                <p className={`text-sm ${theme === 'dark' ? 'text-cyan-300/70' : 'text-black/70'}`}>
