            ...
            {sidebarOpen ? (
              <>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className={`text-sm font-semibold uppercase tracking-wide ${theme === 'dark' ? 'text-cyan-400' : 'text-black'}`} style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif' }}>ORBYT</h2>
