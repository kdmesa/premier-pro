...
"[project]/OneDrive/Desktop/Premier-pro/src/app/admin/settings/industries/form-1/frequencies/new/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FrequencyNewPage() {
    ...
    const storageKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Premier$2d$pro$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FrequencyNewPage.useMemo[storageKey]": ()=>`frequencies_${industry}`
    }["FrequencyNewPage.useMemo[storageKey]"], [
        industry
    ]);
        ...
        "FrequencyNewPage.useEffect": ()=>{
            if (editId && rows.length > 0) {
                const existing = rows.find({
                    "FrequencyNewPage.useEffect.existing": (r)=>r.id === editId
                }["FrequencyNewPage.useEffect.existing"]);
                if (existing) {
                    setForm({
                        name: existing.name,
        ...
        if (form.isDefault) {
            try {
                ...
                const normalized = arr.map((r)=>({
                        ...r,
                        isDefault: editId ? r.id === editId : r.id === Math.max(...arr.map((a)=>a.id))
                    }));
...
_s(FrequencyNewPage, "tt41OYgEUhxQVXUhAfqAGjZEsJo=", false, function() {
    return [
...
_c = FrequencyNewPage;
var _c;
__turbopack_context__.k.register(_c, "FrequencyNewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=OneDrive_Desktop_Premier-pro_src_41186d22._.js.map