...
function CustomerProfilePage() {
    ...
    const [ratingForm, setRatingForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        provider: "",
        score: 5,
        comment: ""
    });
    ...
    const [allBookings, setAllBookings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [providerSearch, setProviderSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [calView, setCalView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("month");
    ...
    const [showContactsList, setShowContactsList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [buttonStates, setButtonStates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        isActive: true,
        isBlocked: false,
        isBookingBlocked: false,
        isSubscribed: true
    });
    const [invoiceFilters, setInvoiceFilters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        type: "all",
        cardStatus: "all",
        payStatus: "all",
        dateRange: null,
    ...
    const [invoiceTab, setInvoiceTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    ...
    const invoices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CustomerProfilePage.useMemo[invoices]": ()=>{
            if (!customer || !allBookings.length) return [];
            const customerBookings = allBookings.filter({
                "CustomerProfilePage.useMemo[invoices].customerBookings": (b)=>(b.customer?.email === customer.email || b.customer?.name === customer.name) && b.amount
            }["CustomerProfilePage.useMemo[invoices].customerBookings"]);
            return customerBookings.map({
                "CustomerProfilePage.useMemo[invoices]": (booking, index)=>{
                    const invoiceDate = new Date(booking.date);
                    const isPaid = booking.status === "completed";
                    const isPending = booking.status === "pending" || booking.status === "confirmed";
                    const dueDateObj = new Date(invoiceDate.getTime() + 30 * 24 * 60 * 60 * 1000);
                    let invoiceType = "active";
                    const now = new Date();
                    if (dueDateObj < now && !isPaid) {
                        invoiceType = "overdue";
                    }
                    return {
                        id: `INV-${booking.id}`,
                        invoiceNumber: `INV-${String(customer.id).slice(-4)}-${String(index + 1).padStart(4, '0')}`,
            ...
            }["CustomerProfilePage.useMemo[invoices]"]).sort({
                "CustomerProfilePage.useMemo[invoices]": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["CustomerProfilePage.useMemo[invoices]"]);
        }
    }["CustomerProfilePage.useMemo[invoices]"], [
        customer,
    ...
    const [invoiceTab, setInvoiceTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    // Filter invoices based on filters and tab
    const filteredInvoices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CustomerProfilePage.useMemo[filteredInvoices]": ()=>{
            let filtered = invoices;
            // Filter by tab
            if (invoiceTab !== "all") {
                filtered = filtered.filter({
                    "CustomerProfilePage.useMemo[filteredInvoices]": (inv)=>inv.invoiceType === invoiceTab
                }["CustomerProfilePage.useMemo[filteredInvoices]"]);
            }
            // Filter by search term
            if (invoiceFilters.searchTerm) {
                const term = invoiceFilters.searchTerm.toLowerCase();
                filtered = filtered.filter({
                    "CustomerProfilePage.useMemo[filteredInvoices]": (inv)=>inv.invoiceNumber.toLowerCase().includes(term) || inv.service.toLowerCase().includes(term)
                }["CustomerProfilePage.useMemo[filteredInvoices]"]);
            }
            // Filter by pay status
            if (invoiceFilters.payStatus !== "all") {
                filtered = filtered.filter({
                    "CustomerProfilePage.useMemo[filteredInvoices]": (inv)=>inv.status === invoiceFilters.payStatus
                }["CustomerProfilePage.useMemo[filteredInvoices]"]);
            }
            // Filter by date range
            if (invoiceFilters.dateRange) {
                filtered = filtered.filter({
                    "CustomerProfilePage.useMemo[filteredInvoices]": (inv)=>{
                        const invDate = inv.invoiceDateObj;
                        return invDate >= invoiceFilters.dateRange.from && invDate <= invoiceFilters.dateRange.to;
                    }
                }["CustomerProfilePage.useMemo[filteredInvoices]"]);
            }
            return filtered;
    ...
    const invoiceStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CustomerProfilePage.useMemo[invoiceStats]": ()=>{
            const paid = invoices.filter({
                "CustomerProfilePage.useMemo[invoiceStats].paid": (inv)=>inv.status === "paid"
            }["CustomerProfilePage.useMemo[invoiceStats].paid"]);
            const partial = invoices.filter({
                "CustomerProfilePage.useMemo[invoiceStats].partial": (inv)=>inv.status === "pending"
            }["CustomerProfilePage.useMemo[invoiceStats].partial"]);
            const totalPaid = paid.reduce({
                "CustomerProfilePage.useMemo[invoiceStats].totalPaid": (sum, inv)=>{
                    const amount = parseFloat(inv.amount.replace(/[^0-9.]/g, ''));
                    return sum + (isNaN(amount) ? 0 : amount);
                }
            }["CustomerProfilePage.useMemo[invoiceStats].totalPaid"], 0);
            const totalPartial = partial.reduce({
                "CustomerProfilePage.useMemo[invoiceStats].totalPartial": (sum, inv)=>{
                    const amount = parseFloat(inv.amount.replace(/[^0-9.]/g, ''));
                    return sum + (isNaN(amount) ? 0 : amount);
                }
            }["CustomerProfilePage.useMemo[invoiceStats].totalPartial"], 0);
            const unpaid = invoices.filter({
                "CustomerProfilePage.useMemo[invoiceStats].unpaid": (inv)=>inv.status === "unpaid" || inv.invoiceType === "overdue"
            }["CustomerProfilePage.useMemo[invoiceStats].unpaid"]);
            const totalUnpaid = unpaid.reduce({
                "CustomerProfilePage.useMemo[invoiceStats].totalUnpaid": (sum, inv)=>{
                    const amount = parseFloat(inv.amount.replace(/[^0-9.]/g, ''));
                    return sum + (isNaN(amount) ? 0 : amount);
                }
            }["CustomerProfilePage.useMemo[invoiceStats].totalUnpaid"], 0);
            const avgOutstanding = unpaid.length > 0 ? totalUnpaid / unpaid.length : 0;
            return {
                totalPaid: {
                    count: paid.length,
                    amount: totalPaid
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: buttonStates.isBlocked ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldCheck$3e$__["ShieldCheck"], {
                                                        className: "h-5 w-5"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                        lineNumber: 405,
                                                                    ...
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    items.slice(0, 3).map((b)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            items.map((b)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    className: "text-xs p-1 rounded text-white",
                                                                                    style: {
                                                                                        background: 'linear-gradient(135deg, #00BCD4 0%, #00D4E8 100%)'
                                                                                    },
                                                    ...
                                                    children: [
                                                        ...
                                                        items.map((b)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    b.provider?.name && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    b.address && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "text-xs text-muted-foreground",
                                                                        children: b.address
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                showContactsList && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-sm text-muted-foreground",
                                                    children: "Here you can view all the invoices that are pending and those that have already been paid."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                    lineNumber: 838,
                                                    columnNumber: 17
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    ...
                                                    onValueChange: (value)=>setInvoiceFilters({
                                                            ...invoiceFilters,
                                                            type: value
                                                        }),
                                                    children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    value: invoiceFilters.cardStatus,
                                                    onValueChange: (value)=>setInvoiceFilters({
                                                            ...invoiceFilters,
                                                            cardStatus: value
                                                        }),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    value: invoiceFilters.payStatus,
                                                    onValueChange: (value)=>setInvoiceFilters({
                                                            ...invoiceFilters,
                                                            payStatus: value
                                                        }),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                    ...
                                                    value: invoiceFilters.dateRange ? `${invoiceFilters.dateRange.from.toLocaleDateString()} - ${invoiceFilters.dateRange.to.toLocaleDateString()}` : "",
                                                    readOnly: true,
                                                    className: "cursor-pointer",
                                                    onClick: ()=>{
                                                        // Simple date range - can be enhanced with calendar picker
                                                        const today = new Date();
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            "all"
                                                ...
                                                className: `px-4 py-2 text-sm font-medium transition-colors border-b-2 ${invoiceTab === tab ? "border-cyan-600 text-cyan-600" : "border-transparent text-muted-foreground hover:text-foreground"}`,
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: invoiceStats.totalPaid.amount.toLocaleString('en-US', {
                                                            style: 'currency',
                                                            currency: 'USD'
                                                        })
                                                    }, void 0, false, {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: [
                                                                        "Partial amount paid(",
                                                                        invoiceStats.partialPaid.count,
                                                                        ")"
                                                                    ]
                                                                }, void 0, true, {
                                                                    fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-semibold",
                                                        children: invoiceStats.partialPaid.amount.toLocaleString('en-US', {
                                                            style: 'currency',
                                                            currency: 'USD'
                                                        })
                                                    }, void 0, false, {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        invoiceStats.avgOutstanding.count,
                                                                        ")"
                                                                    ]
                                                                }, void 0, true, {
                                                                    fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-semibold",
                                                        children: invoiceStats.avgOutstanding.amount.toLocaleString('en-US', {
                                                            style: 'currency',
                                                            currency: 'USD'
                                                        })
                                                    }, void 0, false, {
                                        ...
                                        children: filteredInvoices.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "There are no invoices found."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/customers/[id]/page.tsx",
                                                    lineNumber: 988,
                                                    columnNumber: 21
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            ...
                                                                            children: invoice.status === "paid" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                                ...
                                                                                lineNumber: 1013,
                                                                                columnNumber: 35
                                                                            }, this) : invoice.status === "pending" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
...
_s(CustomerProfilePage, "e+THzIAmKWFYBkjnIGhz2LGFcO4=", false, function() {
    return [
...
//# sourceMappingURL=src_c3483ac1._.js.map